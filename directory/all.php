...
$retu = "*";
$table = "page";
$rule = " ORDER BY page_date DESC LIMIT 0,5";
...
<?php
	...
	headerArea("「サブカテゴリー1-2」カテゴリーに含まれるページ一覧:SetucoCMS",$row_site,$login_name);
?>

                <!-- topicPath START -->
                <div id="topicPath">
                    <p><a href="../index.php">トップ</a><img src="../images/topicPath.gif" width="6" height="11" alt="の中の" /></p>
                    <p><a href="index.php">サイト構造（カテゴリー・ページの一覧）</a><img src="../images/topicPath.gif" width="6" height="11" alt="の中の" /></p>
					<p>「サブカテゴリー1-2」カテゴリーに含まれるページ一覧</p>
                </div>
                <!-- topicpath END -->
                ...
                <div class="section">
                    ...
                    <div class="hArea">
                        ...
                        <h3 id="textType">「サブカテゴリー1-2」カテゴリーに含まれるページ一覧　（5ページ）</h3>
					...
					<p style="margin-left:10px; margin-bottom:10px;"><a href="index.php">カテゴリー・ページの一覧に戻る</a></p>
