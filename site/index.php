                    ...
                    <form action="edit.php" method="post">
                        ...
                        <dl class="editArea">
                            ...
                            <dt><label for="site_name">サイト名</label></dt>
                                <dd><input type="text" id="site_name" name="site_name" value='<?php print $row["site_name"] ?>' onblur="if(this.value == '') { this.value='<?php print $row["site_name"] ?>'; }" /><br />サイト上に表示される名前です。</dd>

                            <dt><label for="site_name">サイトURL<br /><span>（リンク切れに注意）</span></label></dt>
                                <dd><input type="text" id="site_url" name="site_url" value='<?php print $row["site_url"] ?>' onblur="if(this.value == '') { this.value='<?php print $row["site_url"] ?>'; }" /><br />サイトを表示するURLです。</dd>

                            <dt id="site_description_h"><label for="site_description">説明</label></dt>
                                <dd id="site_description_d"><textarea rows="2" id="site_description" name="site_description"><?php print $row["site_description"] ?></textarea><br />サイトの説明です。サイトの概要を入力してください。</dd>
                            ...
                            <dt><label for="site_keyword">キーワード<br /><span>（カンマ[&nbsp;,&nbsp;]で区切る）</span></label></dt>
                                <dd><input type="text" id="site_keyword" name="site_keyword" value='<?php print $row["site_keyword"] ?>' /><br />サイトのキーワードです。サイトに関連する単語を入力してください。</dd>
