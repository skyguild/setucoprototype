...
?>
        ...
        <ul id="gNav">
            ...
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_directory.jpg" alt="サイト構造" width="150" height="30" /></dt>
            ...
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_category.jpg" alt="カテゴリー" width="150" height="30" /></dt>
            ...
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_page.jpg" alt="ページ" width="150" height="30" /></dt>
            ...
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_tag.jpg" alt="タグ" width="150" height="30" /></dt>
                        <dd<?php if ($active == 'tag') print ' id="active"'; ?>><a href="<?php print $rootpath; ?>tag/index.php">追加・編集・削除</a></dd>
                </dl>
            </li>
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_file.jpg" alt="ファイル" width="150" height="30" /></dt>
            ...
            <li>
                <dl>
                    <dt><img src="<?php print $rootpath; ?>images/h_menu_site.jpg" alt="サイト全般" width="150" height="30" /></dt>
